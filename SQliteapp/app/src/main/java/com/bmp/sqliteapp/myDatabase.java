...
public class myDatabase extends SQLiteOpenHelper {
    ...
    public long UpdateData(String bid, String magname, String magprice, String magpage){
        try {
    ...
    public Cursor SelectAllData(){
        try {
            SQLiteDatabase db =this.getReadableDatabase();
            String sql="Select * from tbbook ORDER BY bid DESC";
    ...
    public Cursor Delete(String bid){
        try {
            SQLiteDatabase db = this.getReadableDatabase();
            String sql="Delete * from tbbook where bid='"+bid+"'";
